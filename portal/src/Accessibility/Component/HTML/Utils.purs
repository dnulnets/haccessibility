...
style ∷ forall r i. String
  -> HH.IProp (style ∷ String | r) i
...
maybeElem ∷ forall p i a. Maybe a
  -> (a -> HH.HTML p i)
  -> Array (HH.HTML p i)
...
-- | Render a fragment if the the value exists (Just), empty if not (Nothing)
maybeElem_ ∷ forall p i a. Maybe a
  -> HH.HTML p i
  -> Array (HH.HTML p i)
...
maybeOrElem ∷ forall p i a. Maybe a
  -> HH.HTML p i
  -> (a -> HH.HTML p i)
  -> Array (HH.HTML p i)
...
-- | Render a fragment if the the value exists (Just), and another for if it does not exist (Nothing)
maybeOrElem_ ∷ forall p i a. Maybe a
  -> HH.HTML p i
  -> HH.HTML p i
  -> Array (HH.HTML p i)
